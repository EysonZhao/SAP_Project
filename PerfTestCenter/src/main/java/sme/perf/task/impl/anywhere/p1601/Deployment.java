...
//		}
		...
		try {
			...
			String mariaDBConfigCmd = "mysql -uroot -p"+mariaDBPasswd+" -e \"SET GLOBAL binlog_format = 'MIXED'\";"
					+ "mysql -uroot -p"+mariaDBPasswd+" -e \"set global wait_timeout=28800\"";
	...
	public TaskParameterMap getParameters() {
		if (null == this.parameters) {
			this.parameters = Deployment.getParameterTemplate();
		}
	...
	public TaskParameterMap getHosts() {
		if (null == this.hostParameters) {
			this.hostParameters = Deployment.getHostsTemplate();
		}
