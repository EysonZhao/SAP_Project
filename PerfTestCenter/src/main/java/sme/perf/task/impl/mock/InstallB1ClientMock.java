package sme.perf.task.impl.mock;
...
public class InstallB1ClientMock extends Task{
...
//		}
	...
	public TaskParameterMap getParameters() {
		if(null == this.parameters){
			this.parameters = InstallB1ClientMock.getParameterTemplate();
		}
	...
	public String getDescription() {
		return InstallB1ClientMock.getDescriptionTemplate();
	}
